...
import meetStudent from "../img/Google-Meet-classroom-features.png";
  ...
  return (
    <>
      <div className="container-fluid">
        ...
        <NavLink to="/about" className="text-muted">DevOps</NavLink>
        {/* <h1 className="my-3 text-center">About StarLink</h1> */}
        <div className="box d-flex align-items-center justify-content-center">
          <LiaConnectdevelop style={{ color: "#289bde", fontSize: "4rem" }} />
          <h2 className="text-center my-3">Welcome to StarLink, the Future of Connectivity</h2>
        </div>
        <p className="text-center text-muted">Welcome to StarLink Education, where our mission is to illuminate the path to success for aspiring tech professionals through comprehensive, cutting-edge computer science education. In a world where technology continually reshapes the way we live and work, StarLink stands as a beacon of knowledge and innovation, guiding students toward fulfilling careers in the tech industry.</p>
        ...
        <div className="row my-3 d-flex flex-row" style={{ justifyContent: "space-evenly" }} >
          ...
          <div className="d-flex flex-column">
            ...
            <h2 className="">Our Approuch</h2>
          </div>
        </div>
        <div className="container my-5">

          <h1 className="text-center"> Our Vision</h1>
          <p className="text-center">StarLink Education is more than just an educational institution; we are a movement towards a more informed, skilled, and innovative tech workforce. We envision a world where anyone with the passion to pursue a career in technology has the opportunity, tools, and support to achieve it.</p>
          <h1 className="text-center">Join Us</h1>
          <p className="text-center">Whether you&apos;re starting your journey in computer science or looking to advance your skills, StarLink Education is your partner in achieving your career aspirations. Join us, and be part of a community that&apos;s shaping the future of technology, one course at a time.</p>
