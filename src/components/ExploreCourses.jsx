...
export default function ExploreCourses() {
    ...
    const [getcard, setGetcard] = useState(2);
    let Showcard = (e) => {
        setGetcard(e);
    };
    return (
                    ...
                    <div className="box my-5 p-3 col-md-10">
                            ...
                            <div className="card allcard m-2" style={{ width: "18rem" }}>
                                ...
                                <div className="card-body">
                                    ...
                                    <div style={{ fontSize: "0.8rem", display: "flex", justifyContent: "space-between" }}>
                                        <p>
                                            <span style={{ color: "orange" }}>&#9733;&#9733;</span>&#9733; 4.1(3563rating)
                                        </p>
                                    </div>
                                        <Link to='/Softwaredev' className="">Go somewhere</Link>
                                </div>
                            </div>
                            <div className="card allcard m-2" style={{ width: "18rem" }}>
                                <img src={card} className="card-img-top" style={{ height: "200px" }} alt="..." />
                                <div className="card-body">
                                    ...
                                    <div style={{ fontSize: "0.8rem", display: "flex", justifyContent: "space-between" }}>
                                        ...
                                        <Link className="">Go somewhere</Link>
                                </div>
                            </div>
                            <div className="card allcard m-2" style={{ width: "18rem" }}>
                                <img src={card} className="card-img-top" style={{ height: "200px" }} alt="..." />
                                <div className="card-body">
                                    ...
                                    <br />
                                    <li className="text-muted" style={{ fontSize: "0.8rem" }}>102.2k Learners</li>
                                    <li style={{ fontSize: "0.8rem", display: "flex", justifyContent: "space-between" }}>
                                        <p>
                                            <span style={{ color: "orange" }}>&#9733;&#9733;</span>&#9733; 4.1(3563rating)
                                        </p>
                                        <Link className="">Go somewhere</Link>
                        ...
                        <div className={getcard === 4 ? "fetch-cards d-flex row fade show active" : "fetch-cards d-flex row fade "}>
                            <div className="card allcard m-2" style={{ width: "18rem" }}>
                                <img src={card} className="card-img-top" style={{ height: "200px" }} alt="..." />
                                <div className="card-body">
                                    <h5 className="card-title">Cyber security Advanced</h5>
                                    <li className="text-muted" style={{ fontSize: "0.8rem" }}><span style={{ color: "#289bde", fontSize: "0.7rem" }}>&#10004;</span>    Lorem dolor adipisicing elit.</li>
                                    <li className="text-muted" style={{ fontSize: "0.8rem" }}><span style={{ color: "#289bde", fontSize: "0.7rem" }}>&#10004;</span>    Lorem dolor adipisicing elit.</li>
                                    <li className="text-muted" style={{ fontSize: "0.8rem" }}><span style={{ color: "#289bde", fontSize: "0.7rem" }}>&#10004;</span>    Lorem dolor adipisicing elit.</li>
                                    <li className="text-muted" style={{ fontSize: "0.8rem" }}><span style={{ color: "#289bde", fontSize: "0.7rem" }}>&#10004;</span>    Lorem dolor adipisicing elit.</li>
                            ...
                            <div className="card allcard m-2" style={{ width: "18rem" }}>
                                <img src={card} className="card-img-top" style={{ height: "200px" }} alt="..." />
                                <div className="card-body">
                                    <h5 className="card-title">Cyber Security Beginners</h5>
                                    <li className="text-muted" style={{ fontSize: "0.8rem" }}><span style={{ color: "#289bde", fontSize: "0.7rem" }}>&#10004;</span>    Lorem dolor adipisicing elit.</li>
                                    <li className="text-muted" style={{ fontSize: "0.8rem" }}><span style={{ color: "#289bde", fontSize: "0.7rem" }}>&#10004;</span>    Lorem dolor adipisicing elit.</li>
                                    <li className="text-muted" style={{ fontSize: "0.8rem" }}><span style={{ color: "#289bde", fontSize: "0.7rem" }}>&#10004;</span>    Lorem dolor adipisicing elit.</li>
                                    <li className="text-muted" style={{ fontSize: "0.8rem" }}><span style={{ color: "#289bde", fontSize: "0.7rem" }}>&#10004;</span>    Lorem dolor adipisicing elit.</li>
                            ...
                            <div className="card allcard m-2" style={{ width: "18rem" }}>
                                <img src={card} className="card-img-top" style={{ height: "200px" }} alt="..." />
                                <div className="card-body">
                                    <h5 className="card-title">Ethical hecking</h5>
                                    <li className="text-muted" style={{ fontSize: "0.8rem" }}><span style={{ color: "#289bde", fontSize: "0.7rem" }}>&#10004;</span>    Lorem dolor adipisicing elit.</li>
                                    <li className="text-muted" style={{ fontSize: "0.8rem" }}><span style={{ color: "#289bde", fontSize: "0.7rem" }}>&#10004;</span>    Lorem dolor adipisicing elit.</li>
                                    <li className="text-muted" style={{ fontSize: "0.8rem" }}><span style={{ color: "#289bde", fontSize: "0.7rem" }}>&#10004;</span>    Lorem dolor adipisicing elit.</li>
                                    <li className="text-muted" style={{ fontSize: "0.8rem" }}><span style={{ color: "#289bde", fontSize: "0.7rem" }}>&#10004;</span>    Lorem dolor adipisicing elit.</li>
